        ...
        <main className="mx-auto"style={{ height: `${dvh * 80}px`, width: `${dvw * 90}px` }}>
         {alarms ?  (
          <div>
            {/* <p>test test</p> */}
            {alarms.map((alarm) => (
              <div key={alarm.alarmId} className="m-8 rounded-lg flex items-center" style={{ backgroundColor: '#DDDDDD'}}>
                {/* 왼쪽 1/5 부분에 이미지 추가 */}
                <div className="w-1/5">
                  {/* 펫 이미지는 자신의 펫으로 */}
                ...
                <div className="w-4/5">
                  <p className="text-left flex flex-col justify-center">{alarm.alarmContent}</p>
                  <div className="flex justify-end text-sm" style={{color: '#F55322'}}>
                    <p>자세히 보기</p>
