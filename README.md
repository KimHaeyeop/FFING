...
<div style="display: flex; justify-content: space-between;">
    <img src="https://github.com/user-attachments/assets/c1510f04-97f5-4859-9be0-aee7206c5286" alt="Screenshot 1" width="48%">
</div>
...
| [탁인혁](https://github.com/InhyukTak)   | 팀원 | BE, DB    | 자산 - 입출금, 예금, 적금, 게임 - 펫, 도감 API 개발    |
...
> - 어려움이 있을 때 혼자 충분히 고민하는 것도 중요하지만 적절한 타이밍에 주변 사람들과 함께 고민하고 효율적으로 해결하는 것도 필요하다는 것을 깨달았습니다.
