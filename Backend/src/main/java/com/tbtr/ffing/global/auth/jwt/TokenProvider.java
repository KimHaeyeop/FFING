//package com.tbtr.ffing.global.auth.jwt;
//
...
//     */
//    public String generateToken(String id, Duration expiredAt) {
//        Date now = new Date();
...
//     * @return 생성된 JWT 토큰
//     */
//    private String makeToken(Date expiry, String id) {
//        Date now = new Date();
//
//        return Jwts.builder()
...
//        UserDetails user = userDetailService.loadUserByUsername(id);
//
//        return new UsernamePasswordAuthenticationToken(id, null, user.getAuthorities());
//    }
//
//    /**
