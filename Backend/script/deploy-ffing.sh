...
docker run -d -p 8900:8900 --name ffing-backend-develop -v /home/ubuntu/logs:/home/ubuntu/logs bjho606/ffing-backend-develop:latest \
--network ssafy-network bjho606/ffing-backend-develop:latest
